...
public class PriceTabSelectorActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] titleName = {"行业板块涨幅榜", "行业板块跌幅榜", "概念板块涨幅榜", "概念板块跌幅榜"};
        for (int i = 0; i < 4; i++) {
    ...
    public class MyAsyncTask extends AsyncTask<Void, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null && !result.equals("network anomaly") && !result.equals("")) {
                ...
                adapter = new MyexpandableListAdapter(PriceTabSelectorActivity.this);
                ...
                expandableListView.setOnHeaderUpdateListener(PriceTabSelectorActivity.this);
