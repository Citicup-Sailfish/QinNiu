...
public class ExchangeTabPositionActivity extends ActionBarActivity {

    private ListView SimulationContentList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exchange_tab_position);
        SimulationContentList = (ListView) findViewById(R.id.ExchangeContentList);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null && !result.equals("network anomaly") &&
                ...
                SimpleAdapter simpleAdapter = new SimpleAdapter(
                        ExchangeTabPositionActivity.this,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_exchange_tab_position, menu);
        return true;
    }
